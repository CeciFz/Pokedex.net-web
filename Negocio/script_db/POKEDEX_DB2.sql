...
('Charmeleon',2,4,'Este Pokémon de naturaleza agresiva ataca en combate con su cola llameante y hace trizas al rival con sus afiladas garras.', 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/005.png'),
('Bulbasaur',1,null,'A Bulbasaur es fácil verle echándose una siesta al sol. La semilla que tiene en el lomo va creciendo cada vez más a medida que absorbe los rayos del sol.', 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/001.png'),
('Charmander',2,null,'La llama que tiene en la punta de la cola arde según sus sentimientos. Llamea levemente cuando está alegre y arde vigorosamente cuando está enfadado.', 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/004.png'),
('Squirtle',3,null,'El caparazón de Squirtle no le sirve de protección únicamente. Su forma redondeada y las hendiduras que tiene le ayudan a deslizarse en el agua y le permiten nadar a gran velocidad.', 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/007.png')
